...
<body>
    ...
    <form action="" method="post" name="input">
        ...
        <input type="radio" name="jurusan" 
            <?php if (isset($jurusan) && $jurusan == "TI") echo "checked"; ?> 
                value="TI">Teknik Informatika
        <input type="radio" name="jurusan" 
            <?php if (isset($jurusan) && $jurusan == "SI") echo "checked"; ?> 
                value="SI">Sistem Informasi
        <input type="radio" name="jurusan" 
            <?php if (isset($jurusan) && $jurusan == "SK") echo "checked"; ?> 
                value="SK">Sistem Komputer
        <input type="radio" name="jurusan" 
            <?php if (isset($jurusan) && $jurusan == "KA") echo "checked"; ?> 
